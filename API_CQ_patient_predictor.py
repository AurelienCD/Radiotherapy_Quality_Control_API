...
def main():
    ...
    try:
        ...
        if predict_btn:
            ...
            label = "NB : un résultat non-conforme correspond à une prédiction que le gamma moyen soit significativement en dessus de la moyenne et que le gamma index soit supérieur à 95%"
